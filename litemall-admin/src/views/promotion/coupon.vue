<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        v-permission="['GET /proxy/3000/admin/coupon/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
      ...
      >
      <el-button
        v-permission="['POST /proxy/3000/admin/coupon/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        @click="handleCreate"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['GET /proxy/3000/admin/coupon/read']"
            type="primary"
            size="mini"
          ...
          >
          <el-button
            v-permission="['POST /proxy/3000/admin/coupon/update']"
            type="info"
            size="mini"
          ...
          >
          <el-button
            v-permission="['POST /proxy/3000/admin/coupon/delete']"
            type="danger"
            size="mini"
