<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        v-permission="['GET /proxy/3000/admin/topic/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
    ...
    <div class="operator-container">
      <el-button
        v-permission="['POST /proxy/3000/admin/topic/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        @click="handleCreate"
      ...
      >
      <el-button
        v-permission="['POST /proxy/3000/admin/topic/batch-delete']"
        class="filter-item"
        type="danger"
        icon="el-icon-delete"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /proxy/3000/admin/topic/update']"
            type="primary"
            size="mini"
          ...
          >
          <el-button
            v-permission="['POST /proxy/3000/admin/topic/delete']"
            type="danger"
            size="mini"
