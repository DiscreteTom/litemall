<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="['GET /proxy/3000/admin/aftersale/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
    ...
    <div class="operator-container">
      <el-button
        v-permission="['GET /proxy/3000/admin/aftersale/batch-recept']"
        class="filter-item"
        type="success"
        icon="el-icon-info"
      ...
      >
      <el-button
        v-permission="['GET /proxy/3000/admin/aftersale/batch-reject']"
        class="filter-item"
        type="danger"
        icon="el-icon-delete"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /proxy/3000/admin/aftersale/detail']"
            type="primary"
            size="mini"
          ...
          <el-button
            ...
            v-permission="['POST /proxy/3000/admin/aftersale/recept']"
            type="success"
            size="mini"
          ...
          <el-button
            v-if="scope.row.status === 1"
            v-permission="['POST /proxy/3000/admin/aftersale/reject']"
            type="danger"
            size="mini"
          ...
          <el-button
            ...
            v-permission="['POST /proxy/3000/admin/aftersale/refund']"
            type="warning"
            size="mini"
