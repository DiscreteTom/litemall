<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button
        v-permission="['POST /proxy/3000/admin/category/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        @click="handleCreate"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /proxy/3000/admin/category/update']"
            type="primary"
            size="mini"
          ...
          >
          <el-button
            v-permission="['POST /proxy/3000/admin/category/delete']"
            type="danger"
            size="mini"
