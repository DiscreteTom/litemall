<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="['GET /proxy/3000/admin/notice/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
    ...
    <div class="operator-container">
      <el-button
        v-permission="['POST /proxy/3000/admin/notice/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        @click="handleCreate"
      ...
      >
      <el-button
        v-permission="['GET /proxy/3000/admin/notice/batch-delete']"
        class="filter-item"
        type="danger"
        icon="el-icon-delete"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /proxy/3000/admin/notice/update']"
            type="primary"
            size="mini"
          ...
          >
          <el-button
            v-permission="['POST /proxy/3000/admin/notice/delete']"
            type="danger"
            size="mini"
