<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="['GET /proxy/3000/admin/role/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
      ...
      >
      <el-button
        v-permission="['POST /proxy/3000/admin/role/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
        @click="handleCreate"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /proxy/3000/admin/role/update']"
            type="primary"
            size="mini"
          ...
          >
          <el-button
            v-permission="['POST /proxy/3000/admin/role/delete']"
            type="danger"
            size="mini"
          ...
          >
          <el-button
            v-permission="['GET /proxy/3000/admin/role/permissions']"
            type="primary"
            size="mini"
